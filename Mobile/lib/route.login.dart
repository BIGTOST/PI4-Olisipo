...
class _Page extends State<RouteLogin> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(  // Para garantir que os widgets fiquem dentro da área visível da tela
        child: SingleChildScrollView( // Para permitir o scroll quando o teclado abrir
          child: Container(
                ...
                ElevatedButton(
                  onPressed: () {
                    if (user.text == '' || pass.text == '') {
                      ...
                      s.login(context, username, password, Vars.apiRoute + '/user/login');
                    }
                  },
